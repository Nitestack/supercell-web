...
class AjaxRouter {
    constructor() {
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/getBuilders", async (req, res) => {
            try {
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/getLab", async (req, res) => {
            try {
                const { playerTag, village } = req.body;
                let playerSchema = await Database.getClashOfClansVillage({
                    playerTag: playerTag
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/startBuilderUpgrade", async (req, res) => {
            try {
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/startLaboratoryUpgrade", async (req, res) => {
            try {
                const currentLevel = parseInt(req.body.currentLevel);
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/startPetHouseUpgrade", async (req, res) => {
            try {
                const currentLevel = parseInt(req.body.currentLevel);
                const { unitName, village, playerTag } = req.body;
                const playerSchema = await Database.getClashOfClansVillage({ playerTag: playerTag });
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/updateTimers", async (req, res) => {
            try {
                const { playerTag, village } = req.body;
                let playerSchema = await Database.getClashOfClansVillage({
                    playerTag: playerTag
         ...
         */
        this.router.post("/upgrade-tracker/finishUpgrade", async (req, res) => {
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/upgradeWalls", async (req, res) => {
            try {
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/searchForPlayer", async (req, res) => {
            try {
                const { playerTag } = req.body;
         ...
         */
        this.router.post("/upgrade-tracker/clashofclans/maxAmountAndLevel", (req, res) => {
         ...
         * 
         */
        this.router.post("/upgrade-tracker/clashofclans/applyBoost", async (req, res) => {
            try {
