...
class AdminRouter {
    constructor() {
        this.router = Router();
        this.router.get("/admin", Middleware.Authentication.redirectToLoginPage, Middleware.Authentication.isAdmin, async (req, res) => {
            try {
        ...
        this.router.post("/admin/getEveryUser", Middleware.Authentication.redirectToLoginPage, Middleware.Authentication.isAdmin, async (req, res) => {
            try {
        ...
        this.router.post("/admin/getEveryClashOfClansVillage", Middleware.Authentication.redirectToLoginPage, Middleware.Authentication.isAdmin, async (req, res) => {
            try {
